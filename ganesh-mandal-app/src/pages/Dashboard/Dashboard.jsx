...
import {
  Box, Grid, Typography, Paper, Alert, Button,
} from '@mui/material';
import {
...
const statCardsConfig = [
  ...
  { title: 'Collection Goal', key: 'goalProgress', icon: Target, color: 'amber', format: (v) => `${Math.round(v)}%`, subtitle: `of ${formatIndian(GOAL_AMOUNT)}` },
];
...
export default function Dashboard() {
  ...
  const goalProgress = stats ? Math.min(100, Math.round((stats.thisYearCollection / GOAL_AMOUNT) * 100)) : 0;
